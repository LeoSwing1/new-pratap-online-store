...
function enableDemoChromeNotifications(){if(!('Notification' in window))return toast('Chrome notifications are not supported');Notification.requestPermission().then(x=>x==='granted'?toast('Chrome notifications enabled'):toast('Notification permission was not granted'))}
